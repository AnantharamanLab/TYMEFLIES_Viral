...
# Aim: Mapping metaT to corresponding metaG for 24hrs metaT datasets (2015/8/20-21)
...
# Step 1 Mapping metaT (diel_cycle_metaT) to corresponding metaG for the_24hrs_metaT_ref.based_on_MetaG.fa
mapping_ref_24hrs_metaT_ref = '/storage1/data11/TYMEFLIES_phage/Metatranscriptome/the_24hrs_metaT_ref.based_on_MetaG.fa'
...
mapping_result_dir_diel_cycle_metaT = '/storage1/data11/TYMEFLIES_phage/Metatranscriptome/diel_cycle_metaT___24hrs_metaT_ref_mapping_result_dir'
mapping_metaT_reads(mapping_ref_24hrs_metaT_ref, metaT_reads_diel_cycle_metaT, mapping_result_dir_diel_cycle_metaT, '0.97', '15')