...
## Step 3.4 Get AMG abundances for each month (the number of metagenome each month was normalized)
...
## Step 3.5 Write down AMG abundances (normalized by read number per metagenome and metagenome number per month) for each month
...
## Step 3.6 Get AMG abundances for each year_month (the number of metagenome each year_month was normalized)
...
## Step 3.7 Write down AMG abundances (normalized by read number per metagenome and metagenome number per year_month) for each year_month
