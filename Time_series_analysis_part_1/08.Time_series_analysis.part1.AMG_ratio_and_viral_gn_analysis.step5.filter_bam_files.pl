...
# Note: Need to first enter pysam conda env by "conda activate pysam" (pysam==0.16.0)
=pod
...
`/storage1/data14/for_chao/TYMEFLIES/filter_bam_by_reference.py -b viral_species_rep_bams/original/*.bam -r $scaf_name_file -j 30`;
