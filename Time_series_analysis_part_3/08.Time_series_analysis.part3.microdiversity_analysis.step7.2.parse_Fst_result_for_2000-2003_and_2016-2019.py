...
# Aim: Parse to get the Fst result for 2000-2003 and 2016-2019
...
with open('MetaPop.for_2000-2003_vs_2016-2019/MetaPop/10.Microdiversity/fixation_index.tsv', 'r') as lines:
    for line in lines:
        line = line.rstrip('\n')
...
# pi_1 and pi_2 are nucleotide diversity of 2000-2003 and 2016-2019
# pNpS_1 and pNpS_2 are pN/pS ratio of 2000-2003 and 2016-2019
with open('MetaPop.for_2000-2003_vs_2016-2019/MetaPop/10.Microdiversity/global_gene_microdiversity.tsv', 'r') as lines:
    for line in lines:
        line = line.rstrip('\n')
...
final_fst_result_header_list = ['Gene', 'Fst', 'pi (2000-2003)', 'pi (2016-2019)', 'pi (2000-2003) > pi (2016-2019)', 'pN/pS (2000-2003)', 'pN/pS (2016-2019)', 'pN/pS (2000-2003) < pN/pS (2016-2019)'] + annotation_header.split('\t')
...
f = open('MetaPop.for_2000-2003_vs_2016-2019/gene2final_fst_results.txt', 'w')
...
f = open('MetaPop.for_2000-2003_vs_2016-2019/viral_scf2positively_selected_gene_ratio.txt', 'w')
