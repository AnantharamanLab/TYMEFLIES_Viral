...
# Step 4 Write down gene gain and loss result for four AMGs
## Step 4.1 Store the viral species containing four AMGs
...
## Step 4.2 Write down gene gain and loss result for four AMGs
