...
`metapop -i ./viral_species_rep_bams -r ./reference_fasta_for_metapop -g All_phage_species_rep_gn_containing_AMG.mdfed.genes --norm Read_count_file_for_metapop.txt --id_min 95 --threads 30 --snp_scale both --genome_detection_cutoff 70`;
