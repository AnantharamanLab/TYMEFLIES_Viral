...
`metapop -i ./viral_species_rep_bams -r ./reference_fasta_for_metapop -g All_phage_species_rep_gn_containing_AMG.genes --norm Read_count_file_for_metapop.txt --id_min 92 --threads 20 --snp_scale both --genome_detection_cutoff 70`;

# id_min set to 92 (3% lower than the exact species genome boundary as suggested)
