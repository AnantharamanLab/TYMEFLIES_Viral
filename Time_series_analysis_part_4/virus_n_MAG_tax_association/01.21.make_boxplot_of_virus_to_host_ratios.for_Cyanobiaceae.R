...
data <- read.table("Cyanobiaceae_virus_and_MAG_plots/psbA_date2valid_pair.for_Cyanobiaceae.txt", header = FALSE, sep = "\t")
...
ggsave("Cyanobiaceae_virus_and_MAG_plots/virus2host_ratio_boxplots.pdf", plot, height = 5, width = 3.5, units = "in")
