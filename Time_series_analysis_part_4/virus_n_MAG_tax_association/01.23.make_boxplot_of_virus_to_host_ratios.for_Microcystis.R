...
data <- read.table("Microcystis_virus_and_MAG_plots/psbA_date2valid_pair.for_Microcystis.txt", header = FALSE, sep = "\t")
...
ggsave("Microcystis_virus_and_MAG_plots/virus2host_ratio_boxplots.pdf", plot, height = 5, width = 3.5, units = "in")
