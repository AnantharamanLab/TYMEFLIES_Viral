...
data <- read.table("Methylomonas_virus_and_MAG_plots/pmoC_date2valid_pair.for_Methylomonas.txt", header = FALSE, sep = "\t")
...
ggsave("Methylomonas_virus_and_MAG_plots/virus2host_ratio_boxplots.pdf", plot, height = 5, width = 3.5, units = "in")
