...
data <- read.table("Planktophila_virus_and_MAG_plots/katG_date2valid_pair.for_Planktophila.txt", header = FALSE, sep = "\t")
...
ggsave("Planktophila_virus_and_MAG_plots/virus2host_ratio_boxplots.pdf", plot, height = 5, width = 3.5, units = "in")
