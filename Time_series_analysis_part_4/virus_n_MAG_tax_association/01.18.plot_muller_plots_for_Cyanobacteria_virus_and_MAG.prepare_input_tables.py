...
# Step 10 Store interpolation results for the 10th figure of Other_Cyanobacteria_MAG
## Store the highest y10 value mean
highest_y10_values = []
with open("Other_Cyanobacteria_virus_n_MAG/Other_Cyanobacteria_MAG.year2highest_y_value.txt", 'r') as lines:
    for line in lines:
        line = line.rstrip('\n')
...
## Store interpolation results
interpolation_result_files10 = glob("Other_Cyanobacteria_virus_n_MAG/*.Other_Cyanobacteria_MAG.interpolation_results.txt")
x_data1 = x_mean
...
# Step 11 Store interpolation results for the 11th figure of psbA_containing_Other_Cyanobacteria_viral_gn
## Store the highest y11 value mean
highest_y11_values = []
with open("Other_Cyanobacteria_virus_n_MAG/psbA_containing_Other_Cyanobacteria_viral_gn.year2highest_y_value.txt", 'r') as lines:
    for line in lines:
        line = line.rstrip('\n')
...
## Store interpolation results
interpolation_result_files11 = glob("Other_Cyanobacteria_virus_n_MAG/*.psbA_containing_Other_Cyanobacteria_viral_gn.interpolation_results.txt")
x_data11 = x_mean
...
# Step 12 Store interpolation results for the 12th figure of no_psbA_containing_Other_Cyanobacteria_viral_gn
## Store the highest y12 value mean
highest_y12_values = []
with open("Other_Cyanobacteria_virus_n_MAG/no_psbA_containing_Other_Cyanobacteria_viral_gn.year2highest_y_value.txt", 'r') as lines:
    for line in lines:
        line = line.rstrip('\n')
...
## Store interpolation results
interpolation_result_files12 = glob("Other_Cyanobacteria_virus_n_MAG/*.no_psbA_containing_Other_Cyanobacteria_viral_gn.interpolation_results.txt")
x_data12 = x_mean
...
# Step 13 Get Cyanobacteria_group2host_abun dict and write it down
# Note: The corresponding relationship:
# y_mean_values1 => Cyanobiaceae_MAG abundance mean
# y_mean_values3 => Microcystis_MAG abundance mean
# y_mean_values5 => Planktothrix_MAG abundance mean
# y_mean_values10 => Other_Cyanobacteria_MAG abundance mean

Cyanobacteria_groups = ['Cyanobiaceae', 'Microcystis', 'Planktothrix', 'Other_Cyanobacteria'] 

Cyanobacteria_group2host_abun = {}
for Cyanobacteria_group in Cyanobacteria_groups:
    if Cyanobacteria_group == 'Cyanobiaceae':
        Cyanobacteria_group2host_abun[Cyanobacteria_group] = y_mean_values1
    if Cyanobacteria_group == 'Microcystis':
        Cyanobacteria_group2host_abun[Cyanobacteria_group] = y_mean_values3
    if Cyanobacteria_group == 'Planktothrix':
        Cyanobacteria_group2host_abun[Cyanobacteria_group] = y_mean_values5
    if Cyanobacteria_group == 'Other_Cyanobacteria':
        Cyanobacteria_group2host_abun[Cyanobacteria_group] = y_mean_values10  

## Write down the dict into a table
f = open("Cyanobacteria_group2host_abun.txt", 'w')
header = 'Head' + '\t' + '\t'.join([str(x) for x in x_mean])
f.write(header + '\n')
for Cyanobacteria_group in Cyanobacteria_groups:
    line = Cyanobacteria_group + '\t' + '\t'.join([str(x) for x in Cyanobacteria_group2host_abun[Cyanobacteria_group]])
    f.write(line + '\n')
    
    
# Step 14 Get Cyanobacteria_group2virus_abun dict and write it down    
# Note: The corresponding relationship:
# y_mean_values2 => psbA_containing_Cyanobiaceae_viral_gn abundance mean
# y_mean_values4 => psbA_containing_Microcystis_viral_gn abundance mean
# y_mean_values6 => psbA_containing_Planktothrix_viral_gn abundance mean  
# y_mean_values11 => psbA_containing_Other_Cyanobacteria_viral_gn abundance mean  
# y_mean_values7 => no_psbA_containing_Cyanobiaceae_viral_gn abundance mean
# y_mean_values8 => no_psbA_containing_Microcystis_viral_gn abundance mean
# y_mean_values9 => no_psbA_containing_Planktothrix_viral_gn abundance mean  
# y_mean_values12 => no_psbA_containing_Other_Cyanobacteria_viral_gn abundance mean  

Cyanobacteria_group2virus_abun = {}
for Cyanobacteria_group in Cyanobacteria_groups:
    if Cyanobacteria_group == 'Cyanobiaceae':
        Cyanobacteria_group2virus_abun[Cyanobacteria_group] = [x + y for x, y in zip(y_mean_values2, y_mean_values7)]
    if Cyanobacteria_group == 'Microcystis':
        Cyanobacteria_group2virus_abun[Cyanobacteria_group] = [x + y for x, y in zip(y_mean_values4, y_mean_values8)]
    if Cyanobacteria_group == 'Planktothrix':
        Cyanobacteria_group2virus_abun[Cyanobacteria_group] = [x + y for x, y in zip(y_mean_values6, y_mean_values9)]
    if Cyanobacteria_group == 'Other_Cyanobacteria':
        Cyanobacteria_group2virus_abun[Cyanobacteria_group] = [x + y for x, y in zip(y_mean_values11, y_mean_values12)]  

## Write down the dict into a table
f = open("Cyanobacteria_group2virus_abun.txt", 'w')
header = 'Head' + '\t' + '\t'.join([str(x) for x in x_mean])
f.write(header + '\n')
for Cyanobacteria_group in Cyanobacteria_groups:
    line = Cyanobacteria_group + '\t' + '\t'.join([str(x) for x in Cyanobacteria_group2virus_abun[Cyanobacteria_group]])
    f.write(line + '\n')
